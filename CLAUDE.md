...
- **`./teams-backgrounds/`**: Company Microsoft Teams video backgrounds, served by `ik-teams-backgrounds.service` in place of the Microsoft assets named in `slots.txt`.
