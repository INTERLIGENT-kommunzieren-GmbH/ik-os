...
/usr/bin/dracut --no-hostonly --kver "$QUALIFIED_KERNEL" --reproducible -v --add "ostree i2c_hid_acpi i2c_hid hid_amd usbhid" -f "/lib/modules/$QUALIFIED_KERNEL/initramfs.img"
